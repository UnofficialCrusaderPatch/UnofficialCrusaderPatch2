...
namespace UnofficialCrusaderPatch
{
    ...
    class Version
    {
        ...
        static List<Change> changes = new List<Change>()
        {
            ...
            EditInt32.Create("c_arabxbow", ChangeType.Balancing, 0x4B*4 + 0xB4ED20, 3500),

            // Arab. Schwertkämpfer Angriffsanimation, ca. halbiert
            EditBytes.Create("c_arabwall", ChangeType.Balancing, 0xB59CD0,
            ...
            EditInt32.Create("c_spearxbow", ChangeType.Balancing, 0x18*4 + 0xB4ED20, 9999),
            
             // Bogenschaden gegen Lanzenträger, original: 3500
            EditInt32.Create("c_spearbow", ChangeType.Balancing, 0x18*4 + 0xB4EAA0, 2000),
