    ...
    class Version
    {
        ...
        static List<Change> changes = new List<Change>()
        {
            ...
            */
            ...
            new Change("o_override_identity_menu", ChangeType.Other)
            {
                new DefaultHeader("o_override_identity_menu")
                {
                    ...
                    new BinaryEdit("o_override_identity_menu")
                    {
                        ...
                        new BinAlloc("SetSelectedRangedUnit", null)
                        {
                            ...
                            0x50, //  push eax
                            0x51, //  push ecx
                            //0xB8, new BinRefTo("NormalCrusaderUnitListAddress", false), //  mov eax,NormalCrusaderUnitListAddress
                            ...
                            0xC7, 0x00, 0x05, 0x00, 0x00, 0x00, //  mov [eax],05
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x28, 0x04, 0x00, 0x00, 0x00, //  mov [eax+28],04
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x30, 0x08, 0x00, 0x00, 0x00, //  mov [eax+30],08
                            ...
                            0x3B, 0x05, new BinRefTo("NormalArabUnitListAddress", false), // cmp eax,NormalArabUnitListAddress
                            0x0F, 0x84, 0x0A, 0x00, 0x00, 0x00, //  je short A
                            0xA1, new BinRefTo("NormalArabUnitListAddress", false), //  mov eax,NormalArabUnitListAddress
                            0xE9, new BinRefTo("ResetRangedUnitsInList"), //  jmp ResetRangedUnitsInList
                            0x59,  // pop ecx
                            0x58, //  pop eax
                            0x66, 0x9D, //  popf
                            0xC3 //  ret
                        ...
                        new BinAlloc("SetSelectedMeleeUnit", null)
                        {
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x0C, 0x04, 0x00, 0x00, 0x00, //  mov [eax+0C],04
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x10, 0x04, 0x00, 0x00, 0x00, //  mov [eax+10],05
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x14, 0x03, 0x00, 0x00, 0x00, //  mov [eax+14],03
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x18, 0x02, 0x00, 0x00, 0x00, //  mov [eax+18],02
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x24, 0x05, 0x00, 0x00, 0x00, //  mov [eax+24],05
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x2C, 0x06, 0x00, 0x00, 0x00, //  mov [eax+2C],06
                            ...
                            0x0F, 0x85, 0x21, 0x00, 0x00, 0x00, //  jne short 21
                            0xC7, 0x40, 0x34, 0x05, 0x00, 0x00, 0x00, //  mov [eax+34],05
                            ...
                            0x0F, 0x85, 0x1C, 0x00, 0x00, 0x00, //  jne short 1C
                            0xC7, 0x40, 0x3C, 0x04, 0x00, 0x00, 0x00, //  mov [eax+3C],04
                        ...
                        new BinAlloc("OverrideIdentityMenuRender", null)
                        {
                            ...
                            0x0F, 0x85, 0x05, 0x00, 0x00, 0x00, //  jne short 5
                            0xBE, new BinRefTo("IdentityMenuButtonArray", false), //  mov esi,IdentityMenuButtonArray
                            0x66, 0x9D, //  popf
                            0xC7, 0x43, 0x14, 0x00, 0x00, 0x00, 0x00, //  mov [ebx+14],00
                            0xC3 //  ret
                        },
                        new BinHook(7)  // hook to own func
                        {
