...
namespace UCP
{
    public class Version
    {
        ...
        public static List<Change> Changes { get; } = new List<Change>
                                                      {
                                                          #region BUG FIXES

                                                          // Fix ladder climbing behaviour
                                                          new Change("o_fix_ladderclimb", ChangeType.Bugfix)
                                                          {
             ...
             */
                                                          ...
                                                          new Change("u_fireballistafix", ChangeType.Bugfix)
                                                          {
             ...
             */
                                                          ...
                                                          // 00457DF4
                                                          new Change("ai_buywood", ChangeType.Bugfix)
                                                          {
             ...
             */
                                                          ...
                                                          // Fix AI crusader archers not lighting pitch
                                                          new Change("ai_fix_crusader_archers_pitch", ChangeType.Bugfix)
                                                          {
                                                              new DefaultHeader("ai_fix_crusader_archers_pitch")
                                                              {
                                                          ...
                                                          // Fix baker disappear bug
                                                          new Change("o_fix_baker_disappear", ChangeType.Bugfix)
                                                          {
                                                              new DefaultHeader("o_fix_baker_disappear")
                                                              {
                                                                  new BinaryEdit("o_fix_baker_disappear") // 5774A
                                                          ...
                                                          // Fix moat digging unit disappearing
                                                          new Change("o_fix_moat_digging_unit_disappearing", ChangeType.Bugfix)
                                                          {
                                                              new DefaultHeader("o_fix_moat_digging_unit_disappearing")
                                                              {
             ...
             */
                                                          ...
                                                          {
                                                              new DefaultHeader("ai_attacktarget_nearest")
                                                              {
             ...
             */
                                                          ...
                                                          {
                                                              new DefaultHeader("ai_demolish_walls")
                                                              {
                                                                  // 004D03F4  => jmp to end
                                                              ...
                                                              new DefaultHeader("o_healer")
                                                              {
                                                                  ...
                                                                  new BinaryEdit("o_healer_find")
                                                                  {
                                                                      ...
                                                                      new BinAlloc("healerfind", null)
                                                                      {
                                                                          ...
                                                                          0xE8, new BinRefTo("distfunc"),         //  - call 0046CC80
        ...
        {
            Changes.AddRange(ResourceChange.changes);
            Changes.AddRange(AIVChange.changes);
            Changes.AddRange(StartTroopChange.changes);
        }
