...
namespace UCP.AIC
{
    class AICEnumerator
    {
        ...
        {
            LoadAIC("UCP.Resources.AIC.UCP-AI-Patch.json");
            LoadAIC("UCP.Resources.AIC.vanilla.json");
            LoadAIC("UCP.Resources.AIC.Kimberly-Balance-v1.2.json");
            LoadAIC("UCP.Resources.AIC.Krarilotus-aggressiveAI-v1.2.json");
            LoadAIC("UCP.Resources.AIC.Tatha 0.5.1.json");
            LoadAIC("UCP.Resources.AIC.Xander10alpha-Release-v1.3.json");
        ...
        private static void LoadAIC(string fileName)
        {
            ...
            if (fileName.StartsWith("UCP.Resources.AIC."))
            {
