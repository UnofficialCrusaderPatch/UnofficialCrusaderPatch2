...
{
    /// <summary>
    /// Interaction logic for Control_ai_recruitinterval.xaml
    /// </summary>
    public partial class Control_ai_recruitinterval : UserControl
    {
        private string Identifier = "ai_recruitinterval";
        public Control_ai_recruitinterval()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => ai_recruitinterval.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => ai_recruitinterval.IsChecked = value)
                            .withEnabled(() => ai_recruitinterval.IsChecked == true)
                            .withValue(() => null)
                    })
                );
