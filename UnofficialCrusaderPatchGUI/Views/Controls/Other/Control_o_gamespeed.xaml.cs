...
{
    /// <summary>
    /// Interaction logic for Control_o_gamespeed.xaml
    /// </summary>
    public partial class Control_o_gamespeed : UserControl
    {
        private string Identifier = "o_gamespeed";
        public Control_o_gamespeed()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => o_gamespeed.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => o_gamespeed.IsChecked = value)
                            .withEnabled(() => o_gamespeed.IsChecked == true)
                            .withValue(() => null)
                    })
                );
