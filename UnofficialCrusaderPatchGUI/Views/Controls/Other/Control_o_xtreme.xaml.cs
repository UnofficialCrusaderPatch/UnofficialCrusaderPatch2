...
{
    /// <summary>
    /// Interaction logic for Control_o_xtreme.xaml
    /// </summary>
    public partial class Control_o_xtreme : UserControl
    {
        private string Identifier = "o_xtreme";
        public Control_o_xtreme()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => o_xtreme.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => o_xtreme.IsChecked = value)
                            .withEnabled(() => o_xtreme.IsChecked == true)
                            .withValue(() => null)
                    })
                );
