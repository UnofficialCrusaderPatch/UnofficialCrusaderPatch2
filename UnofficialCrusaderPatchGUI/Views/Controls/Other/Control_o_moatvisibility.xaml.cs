...
{
    /// <summary>
    /// Interaction logic for Control_o_moatvisibility.xaml
    /// </summary>
    public partial class Control_o_moatvisibility : UserControl
    {
        private string Identifier = "o_moatvisibility";
        public Control_o_moatvisibility()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => o_moatvisibility.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => o_moatvisibility.IsChecked = value)
                            .withEnabled(() => o_moatvisibility.IsChecked == true)
                            .withValue(() => null)
                    })
                );
