...
{
    /// <summary>
    /// Interaction logic for Control_o_healer.xaml
    /// </summary>
    public partial class Control_o_healer : UserControl
    {
        private string Identifier = "o_healer";
        public Control_o_healer()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => o_healer.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => o_healer.IsChecked = value)
                            .withEnabled(() => o_healer.IsChecked == true)
                            .withValue(() => null)
                    })
                );
