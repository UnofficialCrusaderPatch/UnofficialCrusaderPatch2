...
{
    /// <summary>
    /// Interaction logic for Control_ai_tethers.xaml
    /// </summary>
    public partial class Control_ai_tethers : UserControl
    {
        private string Identifier = "ai_tethers";
        public Control_ai_tethers()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => ai_tethers.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => ai_tethers.IsChecked = value)
                            .withEnabled(() => ai_tethers.IsChecked == true)
                            .withValue(() => null)
                    })
                );
