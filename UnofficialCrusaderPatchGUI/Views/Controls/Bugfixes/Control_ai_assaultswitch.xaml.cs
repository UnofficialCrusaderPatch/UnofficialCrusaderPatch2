...
{
    /// <summary>
    /// Interaction logic for Control_aiassaultswitch.xaml
    /// </summary>
    public partial class Control_ai_assaultswitch : UserControl
    {
        private string Identifier = "ai_assaultswitch";
        public Control_ai_assaultswitch()
        {
            InitializeComponent();
            ...
            UCPControls.Controls.Add(
                new ControlConfig()
                    ...
                    .withEnabled(() => ai_assaultswitch.IsChecked == true)
                    .withSubControlConfig(new List<SubControlConfig>(){
                        new SubControlConfig()
                            .withIdentifier(this.Identifier)
                            .withSetEnabled((bool value) => ai_assaultswitch.IsChecked = value)
                            .withEnabled(() => ai_assaultswitch.IsChecked == true)
                            .withValue(() => null)
                    })
                );
