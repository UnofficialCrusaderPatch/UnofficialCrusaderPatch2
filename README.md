This project is an unofficial patcher for [FireFly Studio's](https://fireflyworlds.com/) game Stronghold Crusader 1.
...
To install the patch you just have to download the [latest UnofficialCrusaderPatch.exe release](https://github.com/Sh0wdown/UnofficialCrusaderPatch/releases), execute it and choose the correct path of your Stronghold Crusader installation. You can then select several features you wish to install, a recommended presetting is selected by default. The patch should work for most Crusader versions, but the 1.41 HD Steam version is recommended. If you would like to update your version, you can install FireFly's [Crusader HD patch for free](http://www.strongholdcrusaderhd.com/patch.html). If your version is not supported you should receive errors during the installation. 
